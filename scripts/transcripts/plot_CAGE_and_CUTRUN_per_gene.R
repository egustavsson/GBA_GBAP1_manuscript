...
ggsave(plot = GBAP1_transcript_supportive_data_plot, 
       filename = "GBAP1_transcript_supportive_data_plot.png", 
       path = here::here("results", "transcripts"), 
       width = 10, 
       height = 14, 
       dpi = 800
